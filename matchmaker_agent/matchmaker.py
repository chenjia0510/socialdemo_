            ...
            "matches": [
                {
                    ...
                    "recommendation_reason": "用有趣、幽默且一針見血的一段話（單一對話框，不分段）總結推薦理由，必須包含發起者（你）與候選人（他/她）雙方的近期情況與個性特質。語氣像熟識的老朋友一樣生動有趣。",
                    "receiver_reason": "用有趣、幽默且真誠的一段話（單一對話框，不分段）從接收者視角總結，以『你』稱呼接收者，說明對方（以他/她稱呼）最近的情況、個性特質以及他為什麼想認識你。語氣生動有趣。",
